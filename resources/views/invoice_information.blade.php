                        ...
                        <div class="uk-card-default uk-padding uk-card-small">
                            <div id="register" class="tabcontent animation: uk-animation-slide-left-medium">
                                ...
                                <div class="uk-grid uk-margin-small">
                                    <div class="uk-margin-small-bottom">
                                        <textarea style="resize:none;" class="uk-textarea uk-width uk-height-small uk-overflow form-control @error('address') is-invalid @enderror" name="address" id="address" autocomplete="address" placeholder="@lang('front/auth.address')" required>{{ old('address') }}</textarea>
                                        @error('address')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
