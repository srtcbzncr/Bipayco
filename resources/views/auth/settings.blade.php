                        ...
                        <div uk-grid>
                            <div uk-filter="target: .js-filter" class="uk-margin-medium-top">
                                <ul class="uk-subnav uk-subnav-pill" style=" border-bottom: 1px solid #e5e5e5" >
                                    ...
                                    <li uk-filter-control=".tag-security"  style="border-right: 1px solid #e5e5e5"><a href="#">@lang('front/auth.security')</a></li>
                                    <li uk-filter-control=".tag-photo"><a href="#">@lang('front/auth.profile_photo')</a></li>
                                </ul>
                                        ...
                                        <form class="uk-grid-small" uk-grid method="POST" action="{{ route('updatePassword') }}">
                                            ...
                                            <div class="uk-width-2-3@xl">
                                                <div class="uk-width-1-2">
                                                    ...
                                                    <input class="uk-input" name="old_password" type="password" placeholder="@lang('front/auth.password')">
                                                </div>
                                                <div class="uk-width-1-2">
                                                    <div class="uk-form-label"> @lang('front/auth.password_new')</div>
                                                    <input class="uk-input" name="new_password" type="password" placeholder="@lang('front/auth.password')">
                                                </div>
                                                <input class="uk-button uk-button-grey button uk-margin" type="submit" value="@lang('front/auth.save')">
                                            </div>
                                        </form>
