...
@section('content')
    ...
    <div class="uk-container">
        <div class="section-heading uk-position-relative uk-margin-medium-top none-border uk-clearfix">
            <div class="uk-float-left uk-margin-top">
                <h2>@lang('front/auth.live_streams')</h2>
            </div>
            <div class="uk-float-right">
                <a href="{{route('live_course_create_get')}}" class="uk-button uk-button-success uk-margin-small-right uk-margin-small-top"><i class="fas fa-plus uk-margin-small-right"></i>@lang('front/auth.add_lessons')</a>
                <a href="{{route('live_index')}}" class="uk-button uk-button-grey uk-margin-small-top">@lang('front/auth.see_more')</a>
            </div>
        </div>
    </div>
    @if($data['live']==null || count($data['live'])==0)
    <div class="uk-container uk-flex uk-flex-center uk-margin-medium-top">
        <h4 class="uk-text-bold uk-margin-remove-top">@lang('front/auth.not_found_content')</h4>
    </div>
    @else
