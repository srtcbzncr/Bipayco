...
Vue.component('questions-page', require('./components/instructor/questions-page.vue').default);
...
Vue.component('course-students', require('./components/admin/course-students.vue').default);
Vue.component('courses-page', require('./components/admin/courses-page.vue').default);
...
Vue.component('live-stream-button', require('./components/category/live-stream-button.vue').default);
