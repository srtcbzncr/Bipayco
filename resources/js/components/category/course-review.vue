<template>
    <div class="uk-grid-small  uk-margin-medium-top" uk-grid>
        <div class="uk-width-1-5 uk-first-column">
            <img alt="Image" class="uk-width-1-2 uk-margin-small-top uk-margin-small-bottom uk-border-circle uk-align-center  uk-box-shadow-large" src="">
        </div>
        <div class="uk-width-4-5 uk-padding-remove-left">
            <div class="uk-float-right">
                <stars-rating > </stars-rating>
            </div>
            <h4 class="uk-margin-remove">name}} </h4>
            <span class="uk-text-small"> time </span>
            <hr class="uk-margin-small">
            <p class="uk-margin-remove-top uk-margin-small-bottom"> comment</p>
        </div>
    </div>
</template>
<script>
