    ...
    <div class="uk-margin-large-top">
        ...
        <div class="uk-background-default uk-padding-remove uk-margin-small-top border-radius-6">
            <table id="categoryTable" class="uk-table uk-table-hover uk-table-striped uk-width uk-height" cellspacing="0">
                <thead v-if="adminCity.data&&adminCity.data>0">
                <tr>
                    <th>{{cityNameText}}</th>
                    <th>{{cityCodeText}}</th>
                    <th></th>
                ...
                <tbody v-if="adminCity.data&&adminCity.data>0">
        ...
        <ul v-if="adminCity.data&&adminCity.data>0" class="uk-pagination uk-flex-center uk-margin-medium admin-content-inner uk-margin-remove-top uk-padding-remove">
            <li>
