    ...
    <div class="uk-margin-large-top">
        ...
        <div class="uk-background-default uk-padding-remove uk-margin-small-top border-radius-6">
            ...
            <table v-else id="categoryTable" class="uk-table uk-table-hover uk-table-striped uk-width uk-height" cellspacing="0">
                <thead v-if="adminDistrict.data&&adminDistrict.data.length>0">
                <tr>
                    <th>{{districtNameText}}</th>
                    <th></th>
                </tr>
                </thead>
                <tbody v-if="adminDistrict.data&&adminDistrict.data.length>0">
        ...
        <ul v-if="adminDistrict.data&&adminDistrict.data.length>0" class="uk-pagination uk-flex-center uk-margin-medium admin-content-inner uk-margin-remove-top uk-padding-remove">
            <li>
