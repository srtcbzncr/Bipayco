...
Route::get('/iyzico/liveMarkCompleted', 'Iyzico\ConfirmController@liveMarkCompleted')->name('iyzico_live_mark_completed');
...
Route::group(['prefix' => 'instructor', 'middleware' => 'auth'], function(){
   ...
   Route::group(['prefix' => 'ge', 'middleware' => 'hasInstructorProfile'], function(){
    ...
    Route::group(['prefix' => 'live', 'middleware' => 'hasInstructorProfile'], function(){
        Route::get('course/create/{id?}', 'Live\CourseController@createGet')->name('live_course_create_get'); // live_ok
    });
});
