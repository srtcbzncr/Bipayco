...
Route::prefix('instructor')->group(function(){
    ...
    Route::post('course/{id}/sections/{id}/lessons/create/{lesson_id?}','API\GeneralEducation\CourseController@--metot')->name('api_ge_course_sections_lessons_post');
    Route::post('course/{id}/sections/{id}/lessons/delete/{lesson_id}','API\GeneralEducation\CourseController@--metot')->name('api_ge_course_sections_lessons_delete');
